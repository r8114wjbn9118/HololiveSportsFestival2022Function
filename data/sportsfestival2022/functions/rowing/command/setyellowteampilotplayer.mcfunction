...
execute unless score #yellowteamrowingplayercount ateg matches 2 as @p if entity @s[tag=!yellowteamrowingplayer] run function sportsfestival2022:rowing/yellowteam/setplayer/pilot