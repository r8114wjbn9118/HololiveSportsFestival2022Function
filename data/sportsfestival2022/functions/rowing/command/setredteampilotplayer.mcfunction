...
execute unless score #redteamrowingplayercount ateg matches 2 as @p if entity @s[tag=!redteamrowingplayer] run function sportsfestival2022:rowing/redteam/setplayer/pilot