...
execute unless score #whiteteamrowingplayercount ateg matches 2 as @p if entity @s[tag=!whiteteamrowingplayer] run function sportsfestival2022:rowing/whiteteam/setplayer/support