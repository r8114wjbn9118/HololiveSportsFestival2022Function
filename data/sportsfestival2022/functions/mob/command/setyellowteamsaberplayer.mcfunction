...
execute unless score #yellowteammobplayernumber ateg matches 3 as @p if entity @s[tag=!yellowteammobplayer] run function sportsfestival2022:mob/yellowteam/setplayer/saber